...
{
  // Interpolacion lineal entre v0 y v1 en funcion del tiempo t entre t0 y t1 
...
bool FeedForwardController::control(const rclcpp::Time& t, double& v, double& w)
{
  ...
  // Calcular la velocidad lineal resultante (magnitud del vector velocidad)
  v = sqrt(vx*vx + vy*vy);
  
  // La velocidad angular interpolada
  w = va;
