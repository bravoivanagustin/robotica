...
*/
    ...
    double a0 = xa;
    double a1 = vi * cos(thetaa);
    double a2 = 3 * (xb - xa) - 2 * vi * cos(thetaa) - vf * cos(thetab);
    double a3 = -2 * (xb - xa) + vi * cos(thetaa) + vf * cos(thetab);
    
    double b0 = ya;
    double b1 = vi * sin(thetaa);
    double b2 = 3 * (yb - ya) - 2 * vi * sin(thetaa) - vf * sin(thetab);
    double b3 = -2 * (yb - ya) + vi * sin(thetaa) + vf * sin(thetab);
